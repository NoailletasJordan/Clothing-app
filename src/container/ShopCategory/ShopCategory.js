...
const ShopCategory = props => {
	...
	console.log(`url(../../assets/${title.toLowerCase()}.jpg)`)
	...
	return !isAuthorizedRoute ? (
		...
		<Fragment>
			<div className="shop-category__image-section">
				<div
					className={`shop-category__image-section__image u-bg-${title.toLowerCase()}`}
				/>
				<div className="shop-category__image-section__overlay" />
				<div className="shop-category__image-section__content">
					<div className="shop-category__image-section__title">{title}</div>
				</div>
			</div>
				...
				<div className="shop-category">
					<h2 className="shop-category__header">
						...
						>
							...
							<span className="shop-category__go-back__text">
								all categories
							</span>
						</span>
					</h2>
